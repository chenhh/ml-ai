...
假設買東西和隨便逛逛顧客機率分別為20%: 80% (先驗機率)。

第二步是觀察資料，得到兩類人(買東西:隨便逛逛)分別向店員循問的機率分別為90%與30%。
...
* P(買東西的人且循問店員)=20%\*90%=18%
* P(買東西的人且不循問店員)=20%\*10%=2%
* P(隨便逛逛的人且循問店員)=80%\*30%=24%
* P(隨便逛逛的人且不循問店員)=80%\*70%=56%

在現實生活中，若店員遇到客人來循問店員(新增訊息)，則此時可將不問店員的事件排除，因此只剩兩種情況：

* P(買東西的人且循問店員)=20%\*90%=0.18
* P(隨便逛狂的人且循問店員)=80%\*30%=0.24

正規化後下值(後驗機率)，<mark style="color:red;">可判定循問店員的人屬於隨便逛逛類型的機率較高</mark>。
