...
1950年代，圖靈想知道如何電腦能夠像人類一樣思考會有什麼影響，於是提出了模仿遊戲（the imitation game），也稱圖靈測試（Turing test）。此外，圖靈還提出通過測驗的策略：「與其製造程式模擬大人的思考，何不試著模擬小孩的思考？」。如果做的到，就可以用教小孩的方式訓練程式。但小孩的大腦一樣有複雜的機制和範本，到今日還沒有機器可以通過圖靈測試。
