...
對於大多數的人來說，「**因果關係不能被簡化為機率**」這個認識來之不易。哲學家討論原因有很長的歷史。從18、19世紀的David  Hume和John Stuart Mill。20世紀中期的Hans Reichenbach和Patrick Suppes。到現代的Nancy  Cartwright、Wolfgang Spohn和Christpher Hitchcock。特別是Reichenbach和Suupes開始，**哲學家們開始用「機率提高」的概念來定義因果關係：如果**$$X$$**提高了**$$Y$$**的機率，那麼我們就說**$$X$$**導致了**$$Y$$。

此定義通常和直覺一致：「不小心開車會出車禍」，「不認真讀書會被當」，**前者增加了後者發生的可能性，而非必然會讓後者發生**。因此我們會認為，機率提高可讓我們從因果階梯的第一階登上第二階。但是正是這種直覺導致了長期失敗的探索。

失敗的探索不是因為直覺本身，而是概念被形式化表達的方式。哲學家使用條件機率$$P(Y|X) > P(Y)$$表達$$X$$提高$$Y$$的機率。**但這個解釋是錯的，因為「提高」是一個因果概念，而條件機率只涉及觀察和手段，**&#x8868;示如果我們觀察到了$$X$$，則$$Y$$發生的機率就變高了，但這種機率的提高，完全可能是其它因素造成的，如$$Z$$是$$X$$與$$Y$$的共同原因。
