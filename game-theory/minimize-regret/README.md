...
在雙人零和重複賽局$$\Gamma$$​中，玩家的目標是選取好的策略$$s_{1,t} \in \Delta(\mathcal{A}_1),t=1,2,\dots,T$$​以最大化累積報酬$$\sum_{t=1}^T u(s_{1,t}, s_{2,t}), ~ \forall s_{2,t} \in \Delta(\mathcal{A}_2), t=1,2,\dots, T$$。此處最大化報酬是考慮對手在每一期可能採取的所有策略$$s_{2,t}$$。
