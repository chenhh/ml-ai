...
<table><thead><tr><th>名稱</th><th width="150">符號</th><th>關係</th></tr></thead><tbody><tr><td>無條件熵</td><td><span class="math">\mathrm{H}(X)</span></td><td><ul><li><span class="math">\mathrm{H}(X) = \mathrm{H}(X|Y) + \mathrm{I}(X;Y) \geq \mathrm{H}(X|Y)</span></li><li><span class="math">\mathrm{H}(X) = \mathrm{H}(X,Y) - \mathrm{H}(Y|X)</span></li></ul></td></tr><tr><td>無條件熵</td><td><span class="math">\mathrm{H}(Y)</span></td><td><ul><li><span class="math">\mathrm{H}(Y) = \mathrm{H}(Y|X) + \mathrm{I}(X;Y) \geq \mathrm{H}(Y|X)</span></li><li><span class="math">\mathrm{H}(Y) = \mathrm{H}(X,Y) - \mathrm{H}(X|Y)</span></li></ul></td></tr><tr><td>條件熵</td><td><span class="math">\mathrm{H}(X|Y)</span></td><td><span class="math">\mathrm{H}(X|Y) = \mathrm{H}(X,Y) - \mathrm{H}(Y) = \mathrm{H}(X) - \mathrm{I}(X;Y)</span></td></tr><tr><td>條件熵</td><td><span class="math">\mathrm{H}(Y|X)</span></td><td><span class="math">\mathrm{H}(Y|X) = \mathrm{H}(X,Y) - \mathrm{H}(X) = \mathrm{H}(Y) - \mathrm{I}(X;Y)</span></td></tr><tr><td>聯合熵</td><td><span class="math">\mathrm{H}(X,Y) =  \mathrm{H}(Y,X)</span></td><td><span class="math"> \begin{aligned}  &#x26; \mathrm{H}(X,Y)  \\  &#x26;=  \mathrm{H}(X) + \mathrm{H}(Y|X) \\     &#x26; = \mathrm{H}(Y) + \mathrm{H}(X|Y) \\     &#x26; = \mathrm{H}(X)+ \mathrm{H}(Y) - \mathrm{I}(X;Y) \\     &#x26; = \mathrm{H}(X|Y) + \mathrm{H}(Y|X) + \mathrm{I}(X;Y)  \end{aligned}</span></td></tr><tr><td>互資訊</td><td><span class="math">\mathrm{I}(X;Y) = \mathrm{I}(Y;X)</span></td><td><span class="math">\begin{aligned}  &#x26;  \mathrm{I}(X;Y)  \\  &#x26;=  \mathrm{H}(X) - \mathrm{H}(X|Y) \\     &#x26; = \mathrm{H}(Y) - \mathrm{H}(Y|X) \\     &#x26; = \mathrm{H}(X,Y )-  \mathrm{H}(Y|X) - \mathrm{H}(X|Y) \\     &#x26; = \mathrm{H}(X) + \mathrm{H}(Y) - \mathrm{I}(X;Y)  \end{aligned}</span></td></tr></tbody></table>
...
公式中，$$\log$$以2為底時，$$\mathrm{H}(X)$$<mark style="color:red;">之值的單位為bit</mark>；而以自然數$$e$$為底時，$$\mathrm{H}(X)$$之值的單位為nats，以10為基底時，單位為Hartley。

<mark style="background-color:red;">熵的值可解釋為使用二進位編碼隨機變數時，其值等於變數的平均編碼長度</mark>。
