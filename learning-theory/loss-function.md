...
![迴歸函數預測實數值，分類函數預測標簽(類別)](../.gitbook/assets/loss\_function-min.png)
...
![MAE, MSE梯度比較](../.gitbook/assets/mse\_mae\_tradient-min.png)
...
![Huber loss中相異參數對誤差值的曲線](../.gitbook/assets/huber\_loss-min.png)
...
![左/右是變異數為常數/非常數的資料，橘線為OLS估計之值](../.gitbook/assets/ols\_estim-min.png)

![Quantile回歸：虛線表示基於0.05和0.95 分位數損失函數的迴歸估計](../.gitbook/assets/quantile\_regression-min.png)
...
![Quantile Loss（Y軸）與預測值（X軸）關係圖](../.gitbook/assets/quantile\_loss-min.png)
