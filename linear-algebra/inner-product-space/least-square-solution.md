...
* 矩陣$$A \in F^{M \times N} , A=\begin{bmatrix} A_{:1} & \dots & A_{:N}\end{bmatrix}= \begin{bmatrix} A_{1:} \\ \vdots \\ A_{M:} \end{bmatrix}, A^{\mathrm{H}}=  \begin{bmatrix} \overline{A_{1:}} & \dots & \overline{A_{M:1}}\end{bmatrix}$$
* $$A^{\mathrm{H}}A$$
