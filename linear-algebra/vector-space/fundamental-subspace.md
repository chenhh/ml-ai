...
![矩陣的列](../../.gitbook/assets/row\_space-min.png)
...
![矩陣的行](../../.gitbook/assets/col\_space-min.png)
...
![基本子空間的關係](../../.gitbook/assets/fundamental\_space\_mapping-min.png)
...
* 所以$$\forall x_1,x_2 \in ker⁡(A), a,b \in F, Ax_1=0 and Ax_2=0$$可得 $$A(a x_1+bx_2 )=aAx_1+bAx_2=a⋅0+b⋅0=0 \in ker⁡(A)$$ (QED)
