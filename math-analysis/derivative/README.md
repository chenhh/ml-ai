...
![切線](../../.gitbook/assets/tangent\_line-min.png)
...
![函數的一階線性近似](../../.gitbook/assets/linear\_approximation2.png)
...
![局部與全局極大（小）值](../../.gitbook/assets/global\_local\_extreme-min.png)

![實值函數局部極小（大）判別法](../../.gitbook/assets/local\_min\_max\_prop-min.png)

![實值函數局部極小（大）性質](../../.gitbook/assets/local\_min\_max\_table-min.png)
