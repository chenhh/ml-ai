...
自然數或整數上的測度為<mark style="color:red;">計數測度</mark>(<mark style="color:red;">counting measure)。令</mark>$$X=\mathbb{N}$$，$$\Sigma=2^{\mathbb{N}}$$， <mark style="color:red;"></mark> $$\mu: \Sigma \rightarrow [0, \infty]$$
