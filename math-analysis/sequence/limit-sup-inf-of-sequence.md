...
下兩圖中，紅色的線是由$$n$$開始的序列最小上界（最大下界）所連成的線，
即$$\sup\{x_n, x_{n+1},x_{n+2}, \ldots\}$$與$$\inf\{x_n, x_{n+1},x_{n+2}, \ldots\}$$，
而紅色的線在$$n \rightarrow \infty$$時才是$$\limsup x_n$$與$$\liminf x_n$$ 之值。
...
* 同理也可得到 $$\displaystyle \lim_{j \rightarrow \inftyx_{n_j } =m$$ (QED)
