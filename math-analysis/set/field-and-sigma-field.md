...
* $$F=\{ \emptyset, S\}$$，則$$F$$為sigma域 <mark style="color:red;">(最小的sigma域，trivial sigma-field)</mark>。
...
> 給定集合$$S$$，則包含集合$$S$$的最小sigma域記為$$\sigma(S)$$。
>
> $$\sigma(S)$$稱為由集合$$S$$生成的最小sigma域(sigma-field generated by S)。
