...
>
> 第二層：$$F_1$$的兩個閉區間的開區間為$$I_2^1 \cup I_2^2 = (\frac{1}{9}, \frac{2}{9}) \cup (\frac{7}{9}, \frac{8}{9})$$，剩下的閉區間為$$C_2 = [0, \frac{1}{9}] \cup [\frac{2}{9}, \frac{3}{9}] \cup [\frac{4}{9}, \frac{7}{9}] \cup [\frac{8}{9}, 1]$$。
>
> 可得$$F_2=F_2^1 \cup F_2^2 \cup F_2^3 \cup F_2^4 =\frac{C_1}{3}\cup (\frac{2}{3}+\frac{C_1}{3})$$, $$I_2 = \frac{I_1}{3}\cup (\frac{2}{3} +\frac{I_1}{3})$$
>
> 遞迴關係式為
>
