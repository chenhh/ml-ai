...
一個建模方法是將模型以賭局方式呈現：每賭一次要付$$p$$元，若事件$$A$$發生得1元，否則得0元。
因此事件$$A$$發生淨得$$1−p$$元，沒發生得$$−p$$元。若存在唯一的$$p,\ 0 \leq p \leq 1$$使某人認為此賭局公正，則我們說此人對事件$$A$$主觀的機率為$$P(A)=p$$。
...
假設重複做一實驗$$N$$次，其中事件$$A$$出現$$N_A$$ 次，則以$$lim_(N \larrow\infty )⁡ \frac{N}{N_A}$$ 表示$$A$$出現的機率。
