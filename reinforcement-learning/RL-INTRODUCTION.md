...
時序差分學習的起源部分來自於動物學習心理學，特別是次級強化物的概念。次要強化物是指與主要強化物（如食物或疼痛）配對的刺激物，因此，它具有類似的強化特性。Minsky（1954）可能是第一個意識到這個心理學原理對人工學習系統很重要的人。Arthur Samuel（1959年）是第一個提出並實施了包括時間-二元論思想的學習方法的人，作為他著名的跳棋游戲程式的一部分（第16.2節）。
